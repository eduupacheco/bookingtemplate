    ...
    $(this).popover({
        ...
        <div id="quantity" class="row m-0">
            <div id="room-1" class="col p-2 mt-4" style="width: 200px">
                <h6 class="text-success align-middle"><span
                ...
                <div class="row m-0 mt-2">
                    ...
                    <div class="col-5 d-flex p-0">
                        <input class="form-control" type="number" name="quantity-adults" id="quantity-adults" min="1" max="4"
                            value="1">
                    </div>
                </div>
                <div class="row m-0 mt-2">
                    ...
                    <div class="col-5 d-flex p-0">
                        <input class="form-control align-self-center m-0" type="number" name="quantity-children" id="quantity-children" min="0" max="4" value="0">
                    </div>
                </div>
            </div>
